...
<<<<<<< HEAD
    ...
    'help.subtitle': 'دليل شامل لاستخدام منصة كاش',
    'help.howToDeposit': 'كيفية الإيداع',
    'help.howToWithdraw': 'كيفية السحب',
    'help.howToInvite': 'كيفية دعوة الآخرين',
    'help.howPackagesWork': 'كيف تعمل الحزم',
    'help.faq': 'الأسئلة الشائعة',
    'help.step1': 'الخطوة الأولى',
    'help.step2': 'الخطوة الثانية',
    'help.step3': 'الخطوة الثالثة',
    'help.step4': 'الخطوة الرابعة',
    'help.deposit.step1': 'اختر أحد الأرقام الرسمية للإيداع',
    'help.deposit.step2': 'أرسل المبلغ المطلوب إلى الرقم المختار',
    'help.deposit.step3': 'التقط صورة للتحويل',
    'help.deposit.step4': 'أرفق الصورة وقدم طلب الإيداع',
    'help.withdraw.step1': 'تأكد من إكمال التحقق من الهوية',
    'help.withdraw.step2': 'اختر نوع السحب والمبلغ',
    'help.withdraw.step3': 'أدخل تفاصيل الحساب',
    'help.withdraw.step4': 'قدم طلب السحب وانتظر الموافقة',
    'help.invite.step1': 'احصل على رابط الإحالة الخاص بك',
    'help.invite.step2': 'شارك الرابط مع أصدقائك',
    'help.invite.step3': 'احصل على مكافأة عند تسجيلهم',
    'help.invite.step4': 'تابع أرباحك من الإحالات',
    'help.packages.step1': 'اختر الحزمة المناسبة لك',
    'help.packages.step2': 'ادفع رسوم الحزمة',
    'help.packages.step3': 'احصل على المزايا الخاصة',
    'help.packages.step4': 'استمتع بالأرباح الإضافية',
    'help.faq.question1': 'كيف يمكنني إيداع الأموال؟',
    'help.faq.answer1': 'يمكنك إيداع الأموال عن طريق إرسال المبلغ إلى أحد الأرقام الرسمية وإرفاق صورة التحويل.',
    'help.faq.question2': 'كم تستغرق عملية السحب؟',
    'help.faq.answer2': 'تستغرق عملية السحب من 24 إلى 48 ساعة للمراجعة والموافقة.',
    'help.faq.question3': 'كيف يمكنني دعوة أصدقائي؟',
    'help.faq.answer3': 'يمكنك مشاركة رابط الإحالة الخاص بك مع أصدقائك والحصول على مكافآت عند تسجيلهم.',
    'help.faq.question4': 'ما هي أنواع الحزم المتاحة؟',
    'help.faq.answer4': 'نوفر عدة أنواع من الحزم مع مزايا وأرباح مختلفة تناسب جميع المستخدمين.',
    'help.faq.question5': 'كيف يمكنني التحقق من حالة طلبي؟',
...
<<<<<<< HEAD
    ...
    'help.subtitle': 'Complete guide to using Cash platform',
    'help.howToDeposit': 'How to Deposit',
    'help.howToWithdraw': 'How to Withdraw',
    'help.howToInvite': 'How to Invite Others',
    'help.howPackagesWork': 'How Packages Work',
    'help.faq': 'Frequently Asked Questions',
    'help.step1': 'Step 1',
    'help.step2': 'Step 2',
    'help.step3': 'Step 3',
    'help.step4': 'Step 4',
    'help.deposit.step1': 'Choose one of the official deposit numbers',
    'help.deposit.step2': 'Send the required amount to the selected number',
    'help.deposit.step3': 'Take a screenshot of the transfer',
    'help.deposit.step4': 'Attach the screenshot and submit deposit request',
    'help.withdraw.step1': 'Ensure identity verification is completed',
    'help.withdraw.step2': 'Select withdrawal type and amount',
    'help.withdraw.step3': 'Enter account details',
    'help.withdraw.step4': 'Submit withdrawal request and wait for approval',
    'help.invite.step1': 'Get your referral link',
    'help.invite.step2': 'Share the link with your friends',
    'help.invite.step3': 'Earn rewards when they register',
    'help.invite.step4': 'Track your referral earnings',
    'help.packages.step1': 'Choose the package that suits you',
    'help.packages.step2': 'Pay the package fee',
    'help.packages.step3': 'Get exclusive benefits',
    'help.packages.step4': 'Enjoy additional earnings',
    'help.faq.question1': 'How can I deposit money?',
    'help.faq.answer1': 'You can deposit money by sending the amount to one of the official numbers and attaching a transfer screenshot.',
    'help.faq.question2': 'How long does withdrawal take?',
    'help.faq.answer2': 'Withdrawal process takes 24-48 hours for review and approval.',
    'help.faq.question3': 'How can I invite my friends?',
    'help.faq.answer3': 'You can share your referral link with friends and earn rewards when they register.',
    'help.faq.question4': 'What types of packages are available?',
    'help.faq.answer4': 'We offer several types of packages with different benefits and earnings suitable for all users.',
    'help.faq.question5': 'How can I check my request status?',
